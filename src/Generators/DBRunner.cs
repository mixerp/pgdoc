...
{
    internal static class DBRunner
    {
        private static readonly string OutputPath = ConfigurationHelper.GetDatabaseOutputPath();
        private static readonly string TemplatePath = ConfigurationHelper.GetDatabaseTemplatePath();

        internal static void Run()
        {
            Console.WriteLine("Generating documentation for database \"{0}\".", Program.Database.ToUpperInvariant());
