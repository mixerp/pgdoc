...
{
    internal static class MaterializedViewsRunner
    {
        private static readonly string OutputPath = ConfigurationHelper.GetMaterializedViewsOutputPath();
        private static readonly string TemplatePath = ConfigurationHelper.GetMaterializedViewsTemplatePath();
        ...
        private static void BuildDocumentation(string content, List<string> matches)
        {
            ...
            content = Parsers.MaterializedViewParser.Parse(content, matches, views);
