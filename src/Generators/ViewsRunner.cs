...
{
    internal static class ViewsRunner
    {
        private static readonly string OutputPath = ConfigurationHelper.GetViewsOutputPath();
        private static readonly string TemplatePath = ConfigurationHelper.GetViewsTemplatePath();
        ...
        {
            ICollection<PgView> views = ViewProcessor.GetViews();
