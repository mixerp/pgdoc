...
{
    internal static class SequencesRunner
    {
        private static readonly string OutputPath = ConfigurationHelper.GetSequencesOutputPath();
        private static readonly string TemplatePath = ConfigurationHelper.GetSequencesTemplatePath();
