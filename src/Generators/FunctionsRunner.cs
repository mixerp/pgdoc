...
{
    internal static class FunctionsRunner
    {
        private static readonly string OutputPath = ConfigurationHelper.GetFunctionsOutputPath();
        private static readonly string TemplatePath = ConfigurationHelper.GetFunctionsTemplatePath();
