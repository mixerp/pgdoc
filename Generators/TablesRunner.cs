...
{
    internal static class TablesRunner
    {
        private static readonly string OutputPath = ConfigurationHelper.GetTablesOutputPath();
        private static readonly string TemplatePath = ConfigurationHelper.GetTablesTemplatePath();
        ...
        {
            ICollection<PgTable> tables = TableProcessor.GetTables();
