...
{
    internal static class TriggersRunner
    {
        private static readonly string OutputPath = ConfigurationHelper.GetTriggersOutputPath();
        private static readonly string TemplatePath = ConfigurationHelper.GetTriggersTemplatePath();
        ...
        {
            ICollection<PgFunction> triggers = TriggerFunctionProcessor.GetTriggerFunctions();
